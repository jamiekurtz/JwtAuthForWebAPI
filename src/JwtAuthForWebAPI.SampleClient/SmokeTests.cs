...
namespace JwtAuthForWebAPI.SampleClient
{
    ...
    public class SmokeTests
    {
        ...
        public void call_with_expired_token_to_protected_resource_should_fail_with_440()
        {
            ...
            var lt = new Lifetime(DateTime.UtcNow.AddHours(-2), DateTime.UtcNow.AddHours(-1));
        ...
        [Test]
        public void call_with_invalid_signature_should_return_401()
        {
            var client = new HttpClient { BaseAddress = ApiUrl };
            AddAuthHeaderWithSharedKey(client, "http://www.example.com", "abcdefghijklmnopqrstuvwxyz012345");
        ...
        private void AddAuthHeaderWithCert(HttpClient client, string audience = "http://www.example.com",
        ...
        private void AddAuthHeaderWithSharedKey(HttpClient client, string audience, string symmetricKeyToUse = null)
        {
            var tokenString = GetTokenSignedWithSharedKey(audience, symmetricKeyToUse);
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", tokenString);
        }

        private string GetTokenSignedWithSharedKey(string audience, string symmetricKeyToUse = null)
        {
